	...
	public MenuController(Frame frame, SlideViewerComponent slideViewerComponent) {
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				...
				try {
					xmlAccessor.loadFile(slideViewerComponent.getPresentation(), "testPresentation.xml");
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Accessor xmlAccessor = new XMLAccessor();
				try {
					xmlAccessor.saveFile(slideViewerComponent.getPresentation(), "savedPresentation.xml");
				} catch (IOException exc) {
					JOptionPane.showMessageDialog(parent, IOEX + exc,
		...
		viewMenu.add(menuItem = mkMenuItem("New"));
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
